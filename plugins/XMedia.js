...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'x4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {caption: 'feito com 💚 wppBbot'});
            });
    ...
    Asena.addCommand({pattern: 'mp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.image) return await message.sendMessage('*Foto nescessária!*');
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: 'feito com 💚 wppBbot'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'spectrum', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message) return await message.sendMessage('*Áudio nescessário!*');
        var downloading = await message.client.sendMessage(message.jid,'```convertendo..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
    ...
    Asena.addCommand({pattern: 'mp3eq', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (message.reply_message === false) return await message.sendMessage('*Áudio nescessário!*');
        var downloading = await message.client.sendMessage(message.jid,'```Editando..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
    ...
    Asena.addCommand({pattern: 'mp4vintage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (message.reply_message === false) return await message.sendMessage('*Video nescessário!*');
        var downloading = await message.client.sendMessage(message.jid,'```Editando..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
    ...
    Asena.addCommand({pattern: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (message.reply_message === false) return await message.sendMessage('*Foto Necessária!*');
        var downloading = await message.client.sendMessage(message.jid,'```Editando..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
        ...
        ffmpeg(location)
            ...
            .save('output.jpg')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: 'feito com 💚 wppBbot'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'mp4edge', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (message.reply_message === false) return await message.sendMessage('*Video nescessário!*');
        var downloading = await message.client.sendMessage(message.jid,'```Editando Video..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
    ...
    Asena.addCommand({pattern: 'edgeimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (message.reply_message === false) return await message.sendMessage('*Foto Necessária*');
        var downloading = await message.client.sendMessage(message.jid,'```Editando imagem..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
    ...
    Asena.addCommand({pattern: 'gif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output_gif.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output_gif.mp4'), MessageType.video, {mimetype: Mimetype.gif, caption: 'feito com 💚 wppBbot'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'grenimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
        ...
        if (message.reply_message === false) return await message.sendMessage('Foto Necessária!');
        var downloading = await message.client.sendMessage(message.jid,'```Adicionando Gren..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
    ...
    Asena.addCommand({pattern: 'interp ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.video) return await message.sendMessage('*Video nescessário e valor do FPS!*\nEx: ```.interp 100```');
        if (message.reply_message.video && match[1] <= 10) return await message.sendMessage('*Baixo valor de FPS ⚠️*\n*Please, type over 10*');
        if (message.reply_message.video && match[1] >= 500) return await message.sendMessage('*Alto valor de FPS ⚠️*\n*Please, type under 500*')
        ...
        await message.sendMessage('_Esse processo pode demorar um pouco.._');
    ...
    Asena.addCommand({pattern: 'mp4slowmo', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.video) return await message.sendMessage('*Video nescessário!*');
        var downloading = await message.client.sendMessage(message.jid,'```Motion Render Interpolando..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
        ...
        await message.client.sendMessage(message.jid, '_Esse processo pode demorar um pouco.._', MessageType.text);
    ...
    Asena.addCommand({pattern: 'mp4slowmo', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (message.reply_message.video === false) return await message.sendMessage('*Video nescessário!*');
        var downloading = await message.client.sendMessage(message.jid,'```Motion Render Interpolando..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
