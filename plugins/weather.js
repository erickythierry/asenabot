...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'clima ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true}, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    Asena.addCommand({pattern: 'clima ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false}, async (message, match) => {
