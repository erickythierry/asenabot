...
if (Config.WORKTYPE == 'private') {
    Asena.addCommand({pattern: 's$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 's$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
