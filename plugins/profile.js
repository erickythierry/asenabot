...
Asena.addCommand({pattern: 'kickbot', fromMe: false, desc: Lang.KICKME_DESC, onlyGroup: true, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'pp', fromMe: false, desc: Lang.PP_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
Asena.addCommand({pattern: 'block ?(.*)', fromMe: true, desc: Lang.BLOCK_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
Asena.addCommand({pattern: 'unblock ?(.*)', fromMe: true, desc: Lang.UNBLOCK_DESC, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message !== false) {
